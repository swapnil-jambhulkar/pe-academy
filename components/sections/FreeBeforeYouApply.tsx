      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <article className="border border-gray-200 bg-white p-6 md:p-8 flex flex-col">
              ...
              <Button variant="outline" className="w-full sm:w-auto border-black" asChild>
                <Link href={SIMULATOR.slug}>Open the simulator<ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </article>
            <article className="border border-gray-200 bg-white p-6 md:p-8 flex flex-col">
              ...
              <Button variant="outline" className="w-full sm:w-auto border-black" asChild>
                <Link href={GUILD.slug}>Visit the Forum<ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </article>
          </div>
        </motion.div>
