  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSubmitError(result.error || "The message could not be sent. Please try again.");
      }
    } catch {
      setSubmitError("The message could not be sent. Please try again later.");
    }
  };
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-700">
                Admissions, programme, and partnership enquiries.
              </p>
            </motion.div>
          </div>
        </div>
                ...
                <Card className="border-2 border-gray-200">
                  <CardHeader>
                    ...
                    <CardDescription className="text-gray-600">
                      Email us directly or use the form.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">We typically respond within 24 to 48 hours.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-gray-200">
                  ...
                  <CardContent>
                    <p className="text-gray-700 mb-4">
                      The FAQ covers admissions, format, and what the programme does not claim.
                    </p>
              ...
              >
                <Card className="border-2 border-gray-200">
                  <CardHeader>
                    ...
                    <CardDescription className="text-gray-600">
                      Complete the form and we will reply to the email you provide.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {submitted ? (
