...
export default function SimulatorAccessGate({
  ...
  description = "The simulator uses live deal judgment scenarios. Share your profile and resume so we can review your background and follow up on The Principal Programme if relevant.",
