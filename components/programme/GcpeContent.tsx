          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-sm md:text-lg text-white/80 mb-6 md:mb-8">
                Join the GCPE sprint and work under personalised mentorship from a PE founder.
              </p>
              <Button
                variant="default"
                size="lg"
      ...
      <Dialog open={applicationOpen} onOpenChange={setApplicationOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Fill out the application form to apply. We will review your application and get back to you within 48
              hours. Select GCPE on the form.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="text-center space-y-4">
              ...
              <div className="pt-2">
                ...
                <div className="flex items-center gap-2 bg-gray-50 p-3 rounded border">
                  <code className="text-xs text-gray-700 flex-1 break-all">{APPLY_FORM_URL}</code>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-xs"
                    onClick={() => {
                      void navigator.clipboard.writeText(APPLY_FORM_URL);
                    }}
                  >
                    Copy
                  </Button>
            ...
            <Accordion type="single" collapsible className="w-full">
              {[
                ...
                },
                {
                  ...
                  answer:
                    "We do not guarantee placement. We guarantee real deal experience that IB analysts have. You walk away with actual deal work in your portfolio, not textbook case studies. Alumni outcomes are confirmed case by case with admissions.",
                },
                {
