        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="margin-top: 20px;">
              ...
              <p style="margin-top: 15px;">In the meantime, try the <a href="https://norlandacademy.com/simulator" style="color: #000; text-decoration: underline;">Day One Analyst Simulator</a> or review <a href="https://norlandacademy.com/pgp" style="color: #000; text-decoration: underline;">the PGP</a>.</p>
            </div>
